...
---
```{r setup}
knitr::opts_knit$set(root.dir = '../EXPERIMENTS/7_TAIR10_LASTZ')
```
...
Total number of repeats identified is `r length(data$length1)` with a median length of `r median(data$length1)`

Histogram of repeat length
```{r, echo=FALSE}
